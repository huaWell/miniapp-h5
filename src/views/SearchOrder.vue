...
export default {
    ...
    data () {
        return {
            ...
            currentHistory:{},
            mockData: [{name:"test1", displayName: "订单序列号1"},
                {name:"test2", displayName: "订单序列号12"},
                {name:"test3", displayName: "客户13"},
                {name:"test4", displayName: "客户22"},
                {name:"test5", displayName: "物料23"},
                {name:"test6", displayName: "物料24"},
                {name:"test7", displayName: "订单序列号33"},
                {name:"test8", displayName: "客户34"},
                {name:"test9", displayName: "物料35"},
                {name:"test10", displayName: "订单序列号46"}],
            productName: ""
        }
    },
    mounted () {
