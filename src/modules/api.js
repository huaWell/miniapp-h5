...
//homepage
//获取公告
export const get_homepage_announcement = (param = {}) => {
  return service.post('get_announcement', param);
};

//获取待办
export const get_homepage_todo_list = (param = {}) => {
  return service.post('get_todo_list', param);
};

//获取核心指标
export const get_homepage_kpi = (param = {}) => {
  return service.post('get_kpi', param);
};
